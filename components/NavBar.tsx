    ...
    <section>
      ...
      <div className=" nav-sticky">
        <div className=" w-full grid grid-cols-3 py-4 lg:py-10 bg-[#F8F9F8] lg:grid-cols-4">
          ...
          <nav className="lg:flex justify-center items-center gap-10 text-sm hidden col-start-2 col-span-2 text-black opacity-95">
            <Link
              href="/"
